...
(function() {
  ...
  cp.Space.prototype.circleQuery = function(c, r, fn) {
    var detectShape = new cp.CircleShape(undefined, r, cp.v(0,0));
    detectShape.update(c, cp.v(1,0));

    this.shapeQuery(detectShape, fn);
  };
